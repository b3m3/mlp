...
export const SERIALS_POPULAR = API_ROOT+API_SERIALS+API_POPULAR+API_KEY;
export const SERIALS_TOP_RATED = API_ROOT+API_SERIALS+API_TOP_RATED+API_KEY;
export const SERIALS_AIRING_TODAY = API_ROOT+API_SERIALS+API_AIRING_TODAY+API_KEY;
export const SERIALS_ON_THE_AIR = API_ROOT+API_SERIALS+API_ON_THE_AIR+API_KEY;